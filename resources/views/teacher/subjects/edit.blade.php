            ...
            <div class="form-card">
                ...
                <div class="card-heading">
                    ...
                    <div>
                        ...
                        <p>
                            Edit subject details and marks settings
                        </p>
                    </div>
                ...
                <form action="{{ route('teacher.subjects.update', $subject->id) }}"
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <small>
                                Assigned class cannot be changed here.
                            </small>
                        ...
                        <!-- <div class="form-group">
                            ...
                            <select name="subject_type"
                                ...
                                <option value="Theory"
                                    {{ old('subject_type', $classSubject->subject_type) === 'Theory' ? 'selected' : '' }}>
                                    Theory
                                </option>

                                <option value="Practical"
                                    {{ old('subject_type', $classSubject->subject_type) === 'Practical' ? 'selected' : '' }}>
                                    Practical
                                </option>
                    ...
                    <div class="info-box">
                        ...
                        <span>
                            These changes will also update this subject's class mapping and marks settings.
                        </span>

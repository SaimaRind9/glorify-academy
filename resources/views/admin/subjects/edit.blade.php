    ...
    <div class="page-header mb-4">
        <div>
            ...
            <p class="page-description mb-0">
                Update subject information and availability.
            </p>
        </div>
            ...
            <div class="form-card">
                ...
                <div class="card-heading">
                    ...
                    <div>
                        ...
                        <p>Edit the details of {{ $subject->subject_name }}</p>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description"
                                      ...
                                      placeholder="Write a short description about this subject...">{{ old('description', $subject->description) }}</textarea>

    ...
    <div class="page-header mb-4">
        ...
        <div>
            ...
            <p class="page-description mb-0">
                Select a class, subject and assessment method.
            </p>
        </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="subject_type"
                                    ...
                                    <option value="Marks"
                                        {{ old('subject_type') === 'Marks' ? 'selected' : '' }}>
                                    ...
                                    <option value="Grade"
                                        {{ old('subject_type') === 'Grade' ? 'selected' : '' }}>
        ...
        function updateAssessmentFields() {
            ...
            if (selectedType === 'Marks') {
                ...
                if (selectedType === 'Grade') {
                    ...
                    informationTitle.textContent = 'Grade-Based Assessment';
                    ...
                    informationTitle.textContent = 'Activity-Based Assessment';

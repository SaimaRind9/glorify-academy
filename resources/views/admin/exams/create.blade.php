    ...
    <div class="page-header mb-4">
        ...
        <div>
            ...
            <p class="page-description mb-0">
                Add a new examination schedule for a selected class and academic session.
            </p>
        </div>
                ...
                <div class="form-card-header">
                    ...
                    <div>
                        ...
                        <p class="form-card-description mb-0">
                            Enter the class, exam name, academic session and examination dates.
                        </p>
                    ...
                    <div class="form-card-body">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-text">
                                    Select the class for which this exam will be conducted.
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-text">
                                    Active exams will be available for marks entry and result processing.
                                </div>
                        ...
                        <div class="schedule-section mt-4">
                            ...
                            <div class="section-heading mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        Define the starting and ending dates of this examination.
                                    </p>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const schedulePreview = document.getElementById(
            'schedulePreview'
        );

        const schedulePreviewText = document.getElementById(
            'schedulePreviewText'
        );
